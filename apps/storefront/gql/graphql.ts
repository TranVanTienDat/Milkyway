...
export type Banner = {
  ...
  ennabled: Scalars['Boolean']['output'];
...
export type BannerImage_ConnectionArgs = {
  filters?: InputMaybe<UploadFileFiltersInput>;
  pagination?: InputMaybe<PaginationArg>;
  sort?: InputMaybe<Array<InputMaybe<Scalars['String']['input']>>>;
};
...
export type BannerFiltersInput = {
  ...
  ennabled?: InputMaybe<BooleanFilterInput>;
...
export type BannerInput = {
  ...
  ennabled?: InputMaybe<Scalars['Boolean']['input']>;
...
export type GenericMorph = Banner | I18NLocale | ReviewWorkflowsWorkflow | ReviewWorkflowsWorkflowStage | UploadFile | UsersPermissionsPermission | UsersPermissionsRole | UsersPermissionsUser;
